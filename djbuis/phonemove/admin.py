...
#within this app, phonemove, as well as settings to change how
#we view entries within 'phonemove'

#'admin' - necessary to change view settings when viewing an 'phonemove' object
#'messages' - necessary to change success/fail messages when performing an action to an 'phonemove' object
